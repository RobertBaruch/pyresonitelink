"""Generated component: CubicLerp_ColorX.
...
@dataclass
class CubicLerp_ColorX(GeneratedComponent):
    """CubicLerp_ColorX component.

    ResoniteLink schema for FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Math.CubicLerp_ColorX
    """

    COMPONENT_TYPE: ClassVar[str] = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Math.CubicLerp_ColorX"
