"""Generated component: HSV_ToColorX.
...
@dataclass
class HSV_ToColorX(GeneratedComponent):
    """HSV_ToColorX component.

    ResoniteLink schema for FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Color.HSV_ToColorX
    """

    COMPONENT_TYPE: ClassVar[str] = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Color.HSV_ToColorX"
