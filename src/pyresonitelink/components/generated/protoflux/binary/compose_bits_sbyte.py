"""Generated component: ComposeBits_sbyte.
...
@dataclass
class ComposeBits_sbyte(GeneratedComponent):
    """ComposeBits_sbyte component.

    ResoniteLink schema for FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Binary.ComposeBits_sbyte
    """

    COMPONENT_TYPE: ClassVar[str] = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Binary.ComposeBits_sbyte"
