...
@dataclass
class PlayOneShotAndWait(GeneratedComponent):
    """PlayOneShotAndWait component.

    ResoniteLink schema for FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Audio.PlayOneShotAndWait
    """

    COMPONENT_TYPE: ClassVar[str] = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Audio.PlayOneShotAndWait"
    ...
    _MEMBER_NAME_MAP: ClassVar[dict[str, str]] = {
        ...
        "min_scale": "MinScale",
        "on_finished_playing": "OnFinishedPlaying",
    ...
    on_finished_playing: Reference | None = None  # -> FrooxEngine.ProtoFlux.INodeOperation
