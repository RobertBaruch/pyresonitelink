"""Generated component: ReplaceSubstring.
...
@dataclass
class ReplaceSubstring(GeneratedComponent):
    """ReplaceSubstring component.

    ResoniteLink schema for FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Strings.ReplaceSubstring
    """

    COMPONENT_TYPE: ClassVar[str] = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Strings.ReplaceSubstring"
